...
> **工作語言是繁體中文。** `SKILL.md` 與 `lit_api.py` 印出來的狀態欄位都是中文，英文使用者裝了之後拿到的是中文報告——這一點英文版 README 也寫了，寫在他還沒裝之前看得到的地方。
>
> **但檢索一律用英文**：查詢送給 Semantic Scholar／Crossref／arXiv／OpenAlex 時走英文正規術語，回傳的書目欄位維持文獻本身的語言。所以文獻層是語言中立的，外面那層包裝不是。
